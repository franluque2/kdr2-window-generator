...
'Long Con (Stackable) - At the end of each round, get 1 Generic Low Quality Pool at random to add to your inventory. Each stack of this skill gives you a higher quality loot pool (ie Low -> Medium -> High). Max of 3 stacks.',
...
'Mutual Benefits (During each End Phase) (Stackable): Both players draw 1 card. Each stack of this skill increases the amount of cards drawn.',
...
'Sacrifice to the Cards (Once per Duel) (Once per turn) (During your opponent’s turn) (Quick Effect) (Stackable): You can destroy 1 monster you control and draw 2 cards. Your opponent can activate cards/effects in response to the activation of this skill. Each stack of this skill lets you activate this effect an additional time per Duel.',
...
'Tipsy Shopkeep: You know how much you need to tip. When you receive your Tip Skill, gain 5 Gold.',
...
'Dark Emissary - (Once per Duel): If you control a card: You can add 1 “Gorz the Emissary of Darkness” from your Deck to your hand (add 1 “Gorz the Emissary of Darkness” to your inventory).',


'Spell Overflow! (Stackable) - At the end of your turn, gain LP equal to the number of Spell Cards in your GY x 300. Each stack of this skill increases the LP gain by 100.',


'Digging for Treasure!: After you complete your Legendary Quest, excavate the top 10 cards of your Deck, then you can add 1 Treasure, also, 1 Legendary Monster from among them to your hand. Shuffle the rest back into the Deck.',


'Normal Summon Alligator: When you Normal Summon “Alligator\'s Sword” you can add 1 “Kunai with Chain” from your Deck or GY to your hand, then draw 3 cards and discard 2 cards (Add “Alligator\'s Sword” and “Kunai with Chain” to your inventory).',
...
'Heavy Sack: Gain 15 gold at the end of this round, after you collect interest.',
...
'Lucky Die: (Once per Duel): Reveal 1 monster in your hand and roll a six-sided die. The level of that monster becomes that roll until the end of the turn. If the result is higher than 4, draw 1 card.',
...
'Giant Food (Stackable): You can only obtain this skill through the Shop Phase a single time. If you destroy an opponent’s monster by battle, gain a stack of this skill. (Once per turn): You can reveal 1 monster in your hand; spend any number of stacks (min 1) and reduce or increase that card\'s level by the amount spent and treat it as a Tuner until the end of the turn.',
...
'Storm Sceptre: (Once per Duel): If an opponent’s Spell/Trap card is sent to the GY during your turn: you can add 1 “Mystical Space Typhoon” from your Deck to your hand (add “Mystical Space Typhoon” to your Deck, permanently).',


'Cosmic Sceptre: (Once per Duel): If a card in your opponent’s possession is banished: you can pay 1000 LP; add 1 “Cosmic Cyclone” from your Deck to your hand (add 3 “Cosmic Cyclone” to your Deck, permanently).',


'A Tribute to Those Who Lost: (Once per Duel): If a card in your opponent’s possession is destroyed by a card or Skill effect during your turn: you can discard 1 card; add 1 “Tribute to the Doomed” from your Deck to your hand (add 3 “Tribute to the Doomed to your Deck, permanently).',
