...
'Mulligan (Stackable) - At the start of the duel, you can shuffle your hand back into your Deck and draw a new starting hand. Each new stack of this ability allows you to Mulligan an additional time.',


'Parasitic Invasion - Add 3 “Parasite Paracide” to your Deck (permanently). At the start of the Duel, activate the Flip effects of all “Parasite Paracide” in your Deck and Hand. Draw cards to replace the ones activated in your hand so that your hand size is 5 again. If your opponent Special Summons a “Parasite Paracide”, draw 1 card.',


'Scapelamba (Stackable) - Start the game with a Token in play (“Scapelamba” 2000 ATK/2000 DEF Level 4 Earth/Beast). Each stack of this skill grants you an additional token.',


'Staff of Avarice (Stackable) - (Once per Duel) You can shuffle 1 card in your GY back into the Deck to draw 1 card. Each stack of this skill allows you to activate it an additional time per duel.',
...
'A Visit to the Old Sage (Once per Duel): You can reveal 1 Fusion Monster in your Extra Deck, add 1 monster listed on it as a Fusion Material to your hand, then, you can add “Polymerization” from your Deck to your hand (Add “Polymerization” to your inventory).',


'Ritual Tribute - You can conduct a Tribute Summon in addition to your Normal Summon/Set each turn.',


'Card Vendor (During your first Standby Phase) (Once per Duel): You can activate up to 3 “Card Trader” from your Deck. You can activate the effect of “Card Trader” during your opponent\'s Standby Phase. (Add “Card Trader” to your inventory.)',


'Sacrifice to the Cards (Once per Duel) (During your opponent’s turn) (Quick Effect): You can destroy 1 monster you control and draw 2 cards. Your opponent can activate cards/effects in response to the activation of this skill. Each stack of this skill lets you activate this effect an additional time per Duel.',


'Metalmorph (Stackable) - Take 300 damage less from any source of damage. Each stack of this skill increases the damage reduction by 100.',
...
'Hidden Wares: You can reroll all your shown loot once per round.',
...
'Dark Emissary - (Once per Duel): If you control a card: You can add 1 “Gorz the Emissary of Darkness” from your Deck to your hand (add “Gorz the Emissary of Darkness” to your inventory).',


'Normal Summon Alligator: When you Normal Summon “Alligator\'s Sword” you can add 1 “Kunai with Chain” from your Deck or GY to your hand, then draw 2 cards and discard 2 cards (Add “Alligator\'s Sword” and “Kunai with Chain” to your inventory).',
...
'Plundered Booty: When you sell Treasure, you gain 3 Gold per Treasure instead of 1.',


'Chilly Shores (Once per Duel): Next turn, the next 2 times you would take damage, or a monster you control would be destroyed by battle, you do not take damage and that monster is not destroyed.',
...
'The Tragedy: If a monster you control is destroyed by battle you can add 1 “Tragoedia” from your Deck to your hand, and if you do, you can add 1 monster from your GY to your hand. (Add “Tragoedia” to your inventory.)',

'Heavy Sack: Gain 15 gold at the start of the next Shop Phase.',
...
'Beatdown: (Once per Duel) (Stackable): At the start of the Battle Phase, for each monster you control, you can increase the ATK of all monsters you control by 300. Destroy all monsters you control at the end of the Battle Phase. Each stack of this skill increases the ATK gained by 100.',


'Mind Scan: (Once per turn): You can target 1 Set card your opponent controls; you can look at it or declare a card name, and if the card is the declared card destroy it. Cards and effects can be activated in response to this Skill.',


'Lucky Die: (Once per turn): Reveal 1 monster in your hand and roll a six-sided die. The level of that monster becomes that roll until the end of the turn. If the result is higher than 4, draw 1 card.',


'Magic Madness: (Once per Duel): You can banish 3 Spell Cards face-down from your GY. Your opponent randomly picks one of them to add to your hand. This turn, if you activate a Spell, you can banish it face-down. (Once per Duel): You can make your opponent add 1 of your face-down banished cards to your hand at random, and if you do, discard 1 card.',


'We are Number One: (Once per Duel): If you control a level 4 or lower Normal monster, you can Special Summon up to 2 monsters from your Deck with the same name as that monster, also, monsters summoned from the Extra Deck this turn have their effects negated.',
...
'Deck Hurty Virus (Once per Duel) (before the start of the duel): Both players discard 5, mill 5, then draw 5. This does not trigger GY effects of any kind.',


'Minigun (Once per turn) (Stackable): You start the Duel with 500 charges. You can spend any number of charges and lower the ATK 1 face-up monster by that much. If this reduces its ATK to 0, destroy the monster and gain 1000 charges. (Once per turn) (Quick Effect): You can destroy 1 monster you control to gain 1000 charges. This effect can go on chain and is treated as a card effect. Each stack of this skill gives an additional 500 charges at the start of the Duel.',
...
'Wreck-less (Once per Duel): You can discard 1 card; add 1 “Rush Recklessly” from your Deck to your hand. Monsters affected by “Rush Recklessly” do not deal battle damage. (Add “Rush Recklessly” to your inventory).',
...
'Storm Sceptre: (Once per Duel): If an opponent’s Spell/Trap card is sent to the GY during your turn: you can add 1 “Mystical Space Typhoon” from your Deck to your hand (add “Mystical Space Typhoon” to your inventory).',


'Cosmic Sceptre: (Once per Duel): If a card in your opponent’s possession is banished: you can pay 1000 LP; add 1 “Cosmic Cyclone” from your Deck to your hand (add  “Cosmic Cyclone” to your inventory).',


'A Tribute to Those Who Lost: (Once per Duel): If a card in your opponent’s possession is destroyed by a card or Skill effect during your turn: you can discard 1 card; add 1 “Tribute to the Doomed” from your Deck to your hand (add "Tribute to the Doomed" to your inventory).',


'Chainlonk: Once per Duel (Quick Effect): You can activate this Skill as only Chain Link 3 or higher: This current chain resolves forwards instead of backwards.',
...
'Social Distancing: (Once per turn): During your Draw Phase, draw 1 card. Cards you control cannot be in adjacent zones (horizontal or vertical) to each other.',


'Tactical Retreat (Once per Duel) (During the Battle Phase): You can pay half your LP to end the battle phase. If it’s Round 4 or higher, pay 7000LP instead.',


'Entrance Exam (Once per turn): You can send 1 “Duel Academy” from your hand or field to the GY to activate one of the following effects (Add “Duel Academy”, “Polymerization”, “Yubel” and “A Hero Emerges” to your inventory):\n- Add 1 “Polymerization” or 1 “Fusion” Spell from your Deck to your hand.\n- Draw 1 card and reveal it, if it is a monster card, add it to your hand, otherwise, send it to the GY.\n- Reveal the top 3 cards of your Deck and add 1 Trap Card from among them to your hand, then send the rest to the GY.',
