export default {
    ...
    loot_poor: [
'Koa’ki Meiru Beetle / Oily Cicada',
...
'Guard Mantis (OCG)',
'Danger Mothman',
'Humongous Hive Hegemon - Zexstagger / Traptrix Atypus',
...
'Dragonbite / Diabolantis the Menacing Mantis',
...
'Insect Imitation / Insect Neglect',
    ...
    loot_high: [
'Battlewasp - Sting the Poison / Battlewasp - Azusa the Ghost Bow / Battlewasp - Halberd the Charge / Battlewasp - Hama the Conquering Bow / Battlewasp - Ballista the Armageddon / Circle of the Fairies / Tax +1',
'Fissioning Mother Spider (OCG) / Baby Spider (OCG) / Number 5: Doom Chimera Dragon / Tax +1',
